      ...
      <div className="w-3/5 m-6 mb-10">
        ...
        {cart.map((product) => (
          <>
            <div
              key={product.id}
              className="flex items-start mb-4 rounded-2xl p-2 ml-8 bg-rose-200 bg-opacity-25 overflow-y-auto"
            >
              <div className="flex flex-col items-center">
                <img
                  src={product.image}
                  alt={`Image of ${product.name}`}
                  className="object-cover w-40 h-48  rounded-lg"
                />
              </div>
              ...
              <div className="flex items-center ml-40">
                <select
                  ...
                  className=" bg-rose-100 bg-opacity-50 text-gray-800 border rounded px-2 py-1 outline-none"
                >
                  {[...Array(10).keys()].map((i) => (
                    <option key={i + 1} value={i + 1} className="p-2 w-40">
                      {i + 1}
                    </option>
                  ))}
                </select>
              ...
              <button
                type="button"
                className="bg-rose-200 bg-opacity-50 text-gray-800 hover:text-gray-900 rounded-md focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 ml-auto"
      ...
      <div className="w-2/6 ml-6 mr-6 mt-36">
        <div className="bg-neutral-50 p-8 rounded-md">
          ...
          <button
            ...
            className="bg-rose-600 text-white px-2 py-2 rounded-md h-12 w-full mt-2 hover:bg-rose-700"
          >
            Checkout
          </button>
        </div>
        ...
        <div className="mt-4">
          ...
          <div className="flex">
            ...
            <button
              ...
              className="ml-2 bg-rose-600 text-white px-4 py-2 rounded"
            >
              Apply Promo Code
            </button>
          </div>
